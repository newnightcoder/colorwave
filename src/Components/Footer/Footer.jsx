      ...
      <div className="relative w-full max-w-6xl flex flex-col md:flex-row items-center justify-center space-y-8 md:space-x-2 pl-1 py-5">
        ...
        <div className="w-11/12 md:w-max flex flex-col items-center space-y-2">
          ...
          <div className="w-max flex items-center justify-center space-x-8 px-4 pt-1 md:pt-0">
            <a href="https://www.twitter.com/nightcoder2" target="_blank" rel="noopener noreferrer">
              <Twitter className="text-2xl" />
            </a>

            <a href="https://www.github.com/newnightcoder" target="_blank" rel="noopener noreferrer">
              <Github className="text-2xl" />
            </a>

            <a href="https://www.linkedin.com/in/nightcoder-dan" target="_blank" rel="noopener noreferrer">
