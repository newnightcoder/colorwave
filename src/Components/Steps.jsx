    ...
    <div className="h-24 w-screen fixed top-0 flex items-center justify-center bg-black z-50 shadow">
      <div className="h-full w-full max-w-6xl flex items-center justify-center -gap-1">
        ...
        <div className="w-1/3 relative flex items-center justify-center">
          ...
          <div
            style={{ backgroundColor: formOpen ? "rgb(59 130 246)" : "white" }}
        ...
        <div className="w-1/3 relative flex items-center justify-center">
          ...
          <div
            style={{ backgroundColor: formValidated ? "rgb(59 130 246)" : "white" }}
            className="h-px w-1/2 absolute my-auto mx-auto transform translate-x-2/4 ml-1"
          ></div>
        </div>
        ...
        <div className="w-1/3 relative flex items-center justify-center">
          ...
          <div
            style={{ backgroundColor: paymentValidated ? "rgb(59 130 246)" : "white" }}
            className="h-px w-1/2 absolute my-auto mx-auto transform translate-x-2/4 ml-1"
          ></div>
        </div>
        <div className="w-1/3 relative flex items-center justify-center">
