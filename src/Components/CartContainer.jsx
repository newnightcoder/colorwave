  ...
  return (
    ...
    >
      ...
      {items.length === 0 ? (
        ...
        <div
          style={{ height: width < 768 ? "calc(100vh - 250px)" : "calc(100vh - 180px)" }}
          className="w-full md:w-11/12 xl:w-10/12 overflow-y-auto flex flex-col items-center justify-center gap-4 pb-16 md:pb-28 mt-24 md:mt-12"
        >
          {items.map((item, i) => (
            <div
              key={i}
