...
const PaymentBanner = () => {
  return (
    <div className="banner-container h-24 md:h-28 w-full flex items-center justify-center bg-white fixed top-0 z-50 shadow">
      ...
      <div className="banner hidden h-full w-full max-w-8xl md:flex items-center justify-evenly text-gray-900">
        <div className="h-3/4 flex flex-col items-center justify-start transform mt-3 md:mt-6  gap-3 md:gap-2">
        ...
        <div className="h-3/4 md:flex flex-col items-center justify-start transform mt-6  gap-px">
        ...
        <div className="h-3/4 md:flex flex-col items-center justify-start text-center transform mt-6  gap-px">
