...
const CategoryLink = ({ title, img, color }) => {
  return (
    <div className="h-72 flex flex-col justify-center border border-gray-300 transition duration-300 cursor-pointer test" style={{ background: `url("${img}") no-repeat center/cover` }}>
