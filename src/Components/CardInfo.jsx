...
const CardInfo = () => {
  ...
  return (
    <div
      style={{ height: width > 768 ? "23.5rem" : "8rem" }}
      className="w-full md:w-60 text-sm md:text-base text-white bg-black flex flex-col items-center md:items-start justify-center gap-3 md:gap-6 z-40 py-2 md:py-4 rounded-sm"
    >
