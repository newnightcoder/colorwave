  ...
  return (
    ...
    >
      ...
      >
        ...
        <ChevronDown
          className="text-6xl absolute top-1/3 right-4 md:top-3/4 md:right-12 text-white animate-bounce"
      ...
      >
        ...
        <div
          style={{ backgroundColor: width < 768 ? "rgba(250,250,250,.65)" : "transparent" }}
          className="max-w-md relative md:-top-2 text-gray-900 p-8"
        >
      ...
      >
        ...
        <div className="w-full md:max-w-md absolute bottom-0 md:left-0 text-gray-100 text-left p-8">
