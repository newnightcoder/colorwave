  ...
  return (
    ...
    >
      <div className="w-full relative flex items-center justify-start relative mt-4">
        ...
        <span className="w-min relative text-2xl font-bold px-6 ml-32 whitespace-nowrap">
      ...
      <div className="w-full">
        {!variants && location.pathname.includes("limited") ? (
          <div className="h-full w-full grid place-items-center gap-4 md:gap-10 grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 px-6 py-12">
          ...
          subCategories.map((cat, i) => (
            <div id={cat} className="flex flex-col items-center justify-center py-8" key={i + 1}>
              <div className="h-min w-max relative text-center text-2xl capitalize px-8 mb-6">
                <h2 className="text-3xl relative z-10 whitespace-nowrap">{cat}</h2>
