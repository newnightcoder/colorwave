...
const PageNotFound = () => {
  return (
    <div className="h-screen w-screen bg-gray-300 text-gray-100 flex flex-col items-center justify-center space-y-8">
      <h1 className="text-4xl md:text-7xl text-bold">404 - page not found</h1>
      <Link to="/" className="w-max group">
        <div className="relative">
          <span
            className="block border border-gray-100 rounded-sm absolute -inset-1 transform transition-all duration-300 -skew-y-6 bg-yellow-300 group-hover:skew-y-3 group-hover:bg-blue-500"
            aria-hidden="true"
          ></span>
